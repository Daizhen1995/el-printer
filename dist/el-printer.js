(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('core-js/modules/es.array.iterator'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.promise'), require('core-js/modules/es.string.iterator'), require('core-js/modules/web.dom-collections.iterator')) :
	typeof define === 'function' && define.amd ? define(['exports', 'core-js/modules/es.array.iterator', 'core-js/modules/es.object.to-string', 'core-js/modules/es.promise', 'core-js/modules/es.string.iterator', 'core-js/modules/web.dom-collections.iterator'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ElPrinter = {}));
	...
	*/
	...
	var frameId = "zexPrintJS";
	function print() {
	  var printableElementOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	  ...
	  return new promise$3(function (resolve, reject) {
	    ...
	    printFrame.onload = function () {
	      try {
	        ...
	        var printHead = printDocument.getElementsByTagName('head').item(0);
	        cloneElement(printDocument, printableElementOptions);
	        cloneCSS(printHead, printDocument); // cloneScript(printHead, printDocument)

	        loadIframeImages(printDocument).then(function () {
	          try {
	...
	function cloneElement(printDocument, printableElementOptions) {
	  forEach$2(printableElementOptions).call(printableElementOptions, function (_ref) {
	    var el = _ref.el,
	        pageBreak = _ref.pageBreak,
	        _ref$ignoreElements = _ref.ignoreElements,
	        ignoreElements = _ref$ignoreElements === void 0 ? [] : _ref$ignoreElements;
	    ...
	    if (element) {
	      ...
	      var clone = cloneEl(element, ignoreElements);
	...
	function cloneEl(element, ignoreElements) {
	  ...
	  var childNodes = slice$3(Array.prototype).call(element.childNodes);

	  for (var i = 0; i < childNodes.length; i++) {
	    if (includes$4(ignoreElements).call(ignoreElements, childNodes[i].id)) {
	      continue;
	    }

	    var clonedChild = cloneEl(childNodes[i], ignoreElements);
	...
	function cloneLink(printHead, printDocument) {
	  ...
	  forEach$2(_context = from_1$2(linkNodes)).call(_context, function (_ref2) {
	    var rel = _ref2.rel,
	        type = _ref2.type,
	        href = _ref2.href,
	        as = _ref2.as;
	    var link = printDocument.createElement('link');
	    link.rel = rel;
	    link.type = type;
	    link.href = href;
	    link.as = as;
	...
	function cloneStyle(printHead, printDocument) {
	  ...
	  forEach$2(_context2 = from_1$2(styleNodes)).call(_context2, function (_ref3) {
	    var innerHTML = _ref3.innerHTML;
	...
	function loadIframeImages(printDocument) {
	  var imageNodes = printDocument.getElementsByTagName('img');

	  if (imageNodes.length) {
	    var _context4;

	    var promises = map$2(_context4 = from_1$2(imageNodes)).call(_context4, function (image) {
	...
	function loadIframeImage(image) {
	  return new promise$3(function (resolve) {
	    var pollImage = function pollImage() {
	      !image || typeof image.naturalWidth === 'undefined' || image.naturalWidth === 0 || !image.complete ? setTimeout$2(pollImage, 500) : resolve();
	    };
	...
	function performPrint(printFrame, printDocument, zoom) {
	  try {
	    printFrame.focus();
	    printDocument.getElementsByTagName('body')[0].setAttribute('style', "-webkit-print-color-adjust: exact;zoom: ".concat(zoom));
