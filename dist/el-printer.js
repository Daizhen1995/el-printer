(function (global, factory) {
	...
	*/
	...
	function cloneElement(printDocument, printableElementOptions) {
	  printableElementOptions.forEach(function (_ref) {
	    var el = _ref.el,
	...
	function cloneLink(printHead, printDocument) {
	  ...
	  Array.from(linkNodes).forEach(function (_ref2) {
	    var rel = _ref2.rel,
	        type = _ref2.type,
	        href = _ref2.href,
	        as = _ref2.as;
	...
	function cloneStyle(printHead, printDocument) {
	  ...
	  Array.from(styleNodes).forEach(function (_ref3) {
	...
	function loadIframeImages(printDocument) {
	  ...
	  if (imageNodes.length) {
	    var promises = Array.from(imageNodes).map(function (image) {
